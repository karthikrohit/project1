...
#MongoDB Connection
client = pymongo.MongoClient("mongodb+srv://rohitkarthi2015:kar92eee@cluster0.bj8t04d.mongodb.net/?retryWrites=true&w=majority")
...
if question == '1. All the videos and the Channel Name':
    ...
    mydb.commit()
    t7=cursor.fetchall()
    st.write(pd.DataFrame(t7, columns=["Channelname","Totalviews"]))
    ...
    mydb.commit()
    t8=cursor.fetchall()
    st.write(pd.DataFrame(t8,columns=["Name", "Video Publised On", "ChannelNamchannel_ide"]))
